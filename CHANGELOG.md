...
## 2026-08-15：Soma Dynamics KKS v1.0.3.6

- 同步 KK 版 v1.0.3.6 的 PushUp 联动修复：体型刷新期间暂停大腿、手臂和腹部求解，
  连续稳定两帧后重采基准，避免胸托滑条造成肢体变形。
- 延迟胸部/服装刷新只重套胸臀原生 DynamicBone，不再触碰全身 Flesh 状态。
- 小腹增加 `0.020 m` 基准漂移与 `0.045 m` 最终位移双重保护，阻止 Studio 中逐渐
  拉长成“面条”。
