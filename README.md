...
| 目录 | 插件 | KK 版仓库 |
| --- | --- | --- |
| [`SomaDynamics/`](SomaDynamics/) | Soma Dynamics v1.0.2.7（形体动力学控制器，ThighPhysicsController 的 KKS 版） | [DevoLutioner/SomaDynamics](https://github.com/DevoLutioner/SomaDynamics) |
...
- `SomaDynamics_KKS_1.0.2.7.zip`（附 `.sha256`）
